...
function chama_slide(){
	...
	$html = '<header>';
	$html .= '<div class="cycle-slideshow" data-cycle-fx="fade" data-cycle-timeout="6000" data-cycle-speed="1500" data-cycle-slides="> .slider" data-cycle-pager=".cycle-pager" >';
	$html .= '<div id="nav">';
	...
	if (is_home() || is_front_page()) {
		...
		if ( is_category() ) {
			...
			if ( get_post_type() != 'post' ) {
				...
				echo '<li><a href="' . $homeLink . '/blog/">Blog</a></li>';
